...
RGBmatrixPanel matrix(44, 45, 46,47, CLK, LAT, OE, true,64); // 32x16
...
void loop()
{
  ...
  // =========================================
  dwMrq(drawDayDate()   , 100, 1, 1);                          // addr: 3 show Hijriah date
  dwMrq(drawMasjidName(), 100, 1, 2);                          // addr: 2 show Masjid Name
  dwMrq(msgPuasa(hd_puasa, ty_puasa), 100, 1, 3);              // addr: 5 show Remander Puasa
  dwMrq(drawInfo(130)    , 100, 2, 4);                          // addr: 6 show Info 1
  dwMrq(drawInfo(280)   , 100, 2, 5);                          // addr: 8 show Info 2
  dwMrq(drawInfo(430)   , 100, 2, 6);                         // addr: 10 show Info 3
